...
const Home = () => {
    return (
       <>
        ...
        <div className="text-white flex flex-col lg:flex-row lg:mt-[1rem] xl:mt-[0rem] md:mt-[4.438rem] ">
        <div className=" xl:ms-[1.5rem] lg:ms-[.2rem] md:text-center lg:text-left">
            ...
            <div className=" xl:ms-[18.5rem] lg:ms-[14.1rem] md:mx-auto md:mt-24 lg:mt-0 lg:mx-0">
            ...
            <button className='hidden lg:hidden banglaBold 2xl:w-[16.241rem] md:w-[15rem] md:h-[3.5rem] 2xl:h-[4.06rem] md:flex  justify-center items-center  border border-white rounded-full hover:border-none hover:bg-white pt-1 hover:text-[#D01121] 2xl:mt-[76px] md:mt-[3.375rem] lg:mt-[82px]'>শুরু করুন</button>
            </div>

            <div className="hidden md:flex lg:hidden banglaReg text-xs justify-center text-center mt-[7.625rem]">
                <p>&copy;ব্লাড লাগবে ২০২৪, সর্বস্বত্ব সংরক্ষিত<br></br>ব্লাড লাগবে, বাংলাদেশ </p>
            </div>
